...
class Notes extends _Notes with RealmEntity, RealmObjectBase, RealmObject {
  ...
  static SchemaObject _initSchema() {
    ...
    return SchemaObject(ObjectType.realmObject, Notes, 'Notes', [
      const SchemaProperty('id', RealmPropertyType.uuid, primaryKey: true),
      const SchemaProperty('noteFolder', RealmPropertyType.string),
      const SchemaProperty('noteTitle', RealmPropertyType.string),
      const SchemaProperty('noteContext', RealmPropertyType.string),
      const SchemaProperty('noteType', RealmPropertyType.string),
      const SchemaProperty('noteProject', RealmPropertyType.string),
      const SchemaProperty('noteTags', RealmPropertyType.string),
      const SchemaProperty('noteAttachments', RealmPropertyType.string),
      const SchemaProperty('noteReferences', RealmPropertyType.string),
      const SchemaProperty('noteSource', RealmPropertyType.string),
      const SchemaProperty('noteAuthor', RealmPropertyType.string),
      const SchemaProperty('noteNext', RealmPropertyType.string),
      const SchemaProperty('noteLast', RealmPropertyType.string),
      const SchemaProperty('notePlace', RealmPropertyType.string),
      const SchemaProperty('noteIsStarred', RealmPropertyType.bool),
      const SchemaProperty('noteIsLocked', RealmPropertyType.bool),
      const SchemaProperty('noteIstodo', RealmPropertyType.bool),
      const SchemaProperty('noteIsDeleted', RealmPropertyType.bool),
      const SchemaProperty('noteIsShared', RealmPropertyType.bool),
      const SchemaProperty('noteIsAchive', RealmPropertyType.bool),
      const SchemaProperty('noteFinishState', RealmPropertyType.string),
      const SchemaProperty('noteIsReviewed', RealmPropertyType.bool),
      const SchemaProperty('noteCreateDate', RealmPropertyType.timestamp),
      const SchemaProperty('noteUpdateDate', RealmPropertyType.timestamp),
      const SchemaProperty('noteAchiveDate', RealmPropertyType.timestamp),
      const SchemaProperty('noteDeleteDate', RealmPropertyType.timestamp),
      const SchemaProperty('noteFinishDate', RealmPropertyType.timestamp),
      const SchemaProperty('noteAlarmDate', RealmPropertyType.timestamp),
    ]);
  }
}
